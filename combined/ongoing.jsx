...
const SCROLL_FEATURES = [
	{ id: 'a', title: 'Binus University', bg: '#dff2ec' },
	{ id: 'b', title: 'Hanyang University',    bg: '#ede8f7' },
];
...
const ScrollFeatures = () => {
	...
	React.useEffect(() => {
		const onScroll = () => {
			...
			setActive(Math.min(SCROLL_FEATURES.length - 1, Math.floor(progress * SCROLL_FEATURES.length)));
		};
	...
	return (
		<div ref={sectionRef} style={{
			height: `${SCROLL_FEATURES.length * 100}vh`,
			position: 'relative',
		}}>
			<div style={{
				...
				<div style={{
					...
					<div style={{
						...
						borderRadius: 16,
						background: SCROLL_FEATURES[active].bg,
