const PROJECTS = [
	...
	{ id: 'debatecoach', title: 'Debate Coach Agent',   desc: 'AI-powered debate coaching platform — practice argumentation against an LLM opponent with RAG, fallacy detection, and structured feedback.', stack: ['Next.js', 'TypeScript', 'Python', 'FastAPI', 'PostgreSQL'], color1: '#ede9fe', color2: '#ddd6fe', icon: 'assets/icon-project/debate coach/Plugin icon - 1.svg', screenshot1: 'assets/icon-project/debate coach/card 1.png', screenshot2: 'assets/icon-project/debate coach/card 2.png', url: 'https://github.com/ry-rysa/debate-coach-agent', github: 'https://github.com/ry-rysa/debate-coach-agent', tags: ['Web Development', 'NLP'] },
	...
	{ id: 'cupof',       title: 'Cupof',                desc: 'A web & mobile platform connecting users over shared coffee experiences.',        stack: ['React','TypeScript', 'Vite'], color1: '#fce7f3', color2: '#fbcfe8', icon: 'assets/icon-project/cupof/Logo - Blue.png', screenshot1: 'assets/icon-project/cupof/Card 1 - Brand.png', screenshot2: 'assets/icon-project/cupof/Card 2 - Discover.png', url: '', github: 'https://github.com/ry-rysa/cupof',     tags: ['Web Development', 'Mobile App', 'Software Engineer', 'UI/UX'] },
